...
fn test_linear_sum() {
    ...
    let mle1: DenseMleRef<Fr> = DenseMle::new_from_raw(mle_v1, LayerId::Input, None).mle_ref();
...
fn test_dummy_sumcheck_1() {
    ...
    let mle_2: DenseMle<Fr, Fr> = DenseMle::new_from_raw(mle_v2, LayerId::Input, None);

...
use rayon::{
    prelude::{IndexedParallelIterator, IntoParallelIterator, ParallelIterator, IntoParallelRefIterator},
    slice::ParallelSlice,
};
use thiserror::Error;
...
mod test {
    ...
    fn test_aggro_claim() {
        ...
        let res: Claim<Fr> = aggregate_claims(&[claim1, claim2], &mut expr, Fr::from(10)).unwrap();
    ...
    fn test_aggro_claim_2() {
        ...
        let res: Claim<Fr> = aggregate_claims(&[claim1, claim2, claim3], &mut expr, rchal).unwrap();
